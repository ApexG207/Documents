  ...
  const e = env as unknown as Record<string, string | undefined>,
    checks = [
      ...
      },
      {
        ...
        pass: e.MATIQ_TENANT_ISOLATION_V2 === "enforced",
        evidence: e.MATIQ_TENANT_ISOLATION_V2 || "legacy pilot routes remain",
      },
      {
        gate: "G4",
      ...
      },
      {
        ...
        evidence:
          e.MATIQ_BETA_APPROVED === "true" ? "beta approved" : "cohort approval not recorded",
      },
    ],
